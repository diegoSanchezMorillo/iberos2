 ...
 * @author Diego
 */
public class VentasCrear extends javax.swing.JFrame {
    public static ContieneId contieneId = new ContieneId();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ListaProductos listProduc = new ListaProductos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentasCrear.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentasCrear().setVisible(true);
            }
        });
    }
