 ...
 * @author Diego
 */
public class ComprasVer extends javax.swing.JFrame {
    
    OperacionesCompras operaciones = new OperacionesCompras();
    DefaultTableModel tabla = new DefaultTableModel();
    Set<Tiene> productos = new HashSet<>();
    Tiene tiene = new Tiene();
    TieneId tieneId = new TieneId();
   ...
   void cargarVentas(){
        tabla.setRowCount(0);
        List<Compras> lista = operaciones.ListaCompras();
        tabla = (DefaultTableModel) jTableCompras.getModel();
        ...
        if(lista.size()>0){
            ...
            while(consulta.hasNext()){
                ...
                Compras fila = (Compras)consulta.next();
                datos.add(fila.getIdcompras());
                datos.add(fila.getReferencia());
                datos.add(fila.getImporte());
                proveedor = fila.getProveedores();
                datos.add(proveedor.getNombre());
    ...
    private void initComponents() {
        ...
        jTableCompras.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Referencia", "Importe", "Proveedor", "Fecha"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int fila;
        fila = (Integer)this.jTableCompras.getSelectedRow();
        int id = (Integer)this.jTableCompras.getValueAt(fila, 0);
        
        compra.setIdcompras(id);
        compra = operaciones.seleccionaCompra(compra);
        tiene.setCompras(compra);
        productos = tiene.getCompras().getTienes();
         if(productos.size()>0){
        ...
        //operaciones.eliminaCompra(compra,tiene,tieneId);
    ...
    private void jButtonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonModificarActionPerformed
        ...
        fila = (Integer)this.jTableCompras.getSelectedRow();
        int id = (Integer)this.jTableCompras.getValueAt(fila, 0);
        ComprasModificar comprasMod = new ComprasModificar();
        int idProduc;
        
        compra.setIdcompras(id);
        compra = operaciones.seleccionaCompra(compra);
        
        comprasMod.jLabelTotal.setText(String.valueOf(compra.getImporte()));
        
        this.dispose();
        comprasMod.setVisible(true);
         ...
         tabla2 = (DefaultTableModel) comprasMod.jTableProductos.getModel();
                ...
                if(productos.size()>0){
                   Iterator<Tiene> it = productos.iterator();
                    ...
                    datos2.add(tiene.getCantidad());
                    datos2.add(producto.getPrecioVenta());
                    datos2.add(producto.getPrecioVenta()*tiene.getCantidad());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        ComprasCrear cc = new ComprasCrear();
        cc.setVisible(true);
    ...
    private void jMenuProveedoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenuProveedoresMouseClicked
        // TODO add your handling code here:
        ComprasVer proveedoresV = new ComprasVer();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComprasVer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ComprasVer().setVisible(true);
            }
        });
    }
