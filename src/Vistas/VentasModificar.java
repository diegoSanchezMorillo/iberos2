...
public class VentasModificar extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            // TODO add your handling code here:
             VentasVer vv = new VentasVer();
            venta = vv.venta;
            int numero = venta.getIdventas();
            HashMap parametro = new HashMap();
            Conexion con = new Conexion();
            Connection conexion = con.getConexion();
        
            parametro.put("id", numero);
            JasperReport jr = JasperCompileManager.compileReport("C:\\Users\\Diego\\Documents\\NetBeansProjects\\iberos2\\src\\Vistas\\reportVentas.jrxml");
