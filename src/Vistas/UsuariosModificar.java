 ...
 * @author Diego
 */
public class UsuariosModificar extends javax.swing.JFrame {
    ...
    private void jButtonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGuardarActionPerformed
       ...
       operaciones.actualizaUsuario(usuario);
       this.dispose();
       UsuariosVer userV = new UsuariosVer();
       userV.cargarUsuarios();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsuariosModificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UsuariosModificar().setVisible(true);
            }
        });
    }
